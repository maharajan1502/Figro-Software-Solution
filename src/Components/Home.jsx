...
const Home = () => {
  return (
    <div className=' bg-[#FFFFFF] h-auto border-b-2 border-black w-auto'> 
     <Navbar/>
     ...
     <div>
        <marquee className='flex p-6' direction="left">
            <div className='flex space-x-20'>
              <div className='px-5 py-3 p-8 bg-[#bcd8d4] items-center justify-center text-center flex space-x-3'>
